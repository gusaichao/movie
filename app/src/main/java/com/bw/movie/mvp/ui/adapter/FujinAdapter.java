...
public class FujinAdapter extends RecyclerView.Adapter<FujinAdapter.Myvh> {
    ...
    public void setList(List<FujinBean.ResultBean> list) {
        this.list = list;
    ...
    public void setOnclicklisnter(FujinAdapter.onclicklisnter onclicklisnter) {
